...
void _test_RouterTest_tc_GetEndpointUnknown(
...
void _test_RouterTest_tc_GetIndex(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetMessage(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetMessageWithUriParam(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithCommonParts(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithLargeBody(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithMultipleParams(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithOnePart(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithParams(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithPercentEncodingParams(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_GetRouteWithTwoParts(
    test_RouterTest this)
{
...
void _test_RouterTest_tc_PostEndpoint(
    test_RouterTest this)
{
